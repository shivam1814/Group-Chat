...
class PrivateChatAdapter (list:ArrayList<MessageModel>,var user_id:String): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if(viewType==2)
        {
            return MessageViewModel(LayoutInflater.from(parent.context).inflate(R.layout.acceptreject_layout,parent,false))
        }
